...
public final class DriveConstants {
    ...
    // Physical properties
    public static final double TRACK_WIDTH = VisionConstants.TAG_LAYOUT.getFieldWidth();
    public static final double TRACK_LENGTH = VisionConstants.TAG_LAYOUT.getFieldLength();
